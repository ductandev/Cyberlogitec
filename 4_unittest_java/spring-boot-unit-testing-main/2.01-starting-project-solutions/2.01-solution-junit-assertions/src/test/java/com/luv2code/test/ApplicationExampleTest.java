...
@SpringBootTest(classes= MvcTestingExampleApplication.class)        // ✅ Cách để đặt tên khác package nhưng vẫn chạy được bìhh thường
public class ApplicationExampleTest {
    ...
    public void addGradeResultsForStudentGradesAssertNotEquals() {
        assertEquals(0, studentGrades.addGradeResultsForSingleClass(
                student.getStudentGrades().getMathGradeResults()
        ));
    }
